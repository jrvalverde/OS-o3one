...
thread_halted_p: .quad	oz_sys_thread_halted

##########################################################################
##									##
...
oz_sys_condhand_call:
	...
	mov	$16,$10			# save sigargs pointer
	mov	$17,$11			# save mchargs pointer
	ldq	$27,thread_halted_p-b13($13)
	jsr	$26,($27)		# see if we're halted by a debugger
	ldq	 $1,resume_p-b13($13)	# see if it returned OZ_RESUME
	ldl	 $1,0($1)		# ... to resume execution where we left off
	subl	 $1,$0,$1
	beq	 $1,call_resume

	mov	$10,$16			# restore sigargs pointer
	mov	$10,$17			# restore mchargs pointer
