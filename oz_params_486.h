...
#define MAXSYSPAGES (0x08000000/4096)					// max possible total number of system pages 
									// ... it all ends before default link address 0x08048000
									// = 32K pages = 128Mbytes
...
#define PROCMPDVPAGE 0x000FFFFE						// page of the process' own page directory
#define PROCMPDVADDR 0xFFFFE000						// address of the process' own page directory
