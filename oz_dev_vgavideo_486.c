...
/* This is called at the very beginning of the load process so we can use it to print stuff via oz_dev_vgavideo_putcon */

void oz_dev_vgavideo_init (void)

{
  ...
  oz_dev_vgavideo_putchar (NULL, '!');			/* put an '!' there */
}
...
void oz_dev_vgavideo_exclusive (int flag)
...
void oz_dev_vgavideo_putcon (uLong size, const char *buff)
...
void oz_dev_vgavideo_putchar (OZ_Vctx *vctx, char c)
...
void oz_dev_vgavideo_statusupdate (Long cpuidx, uByte cpulevel, uByte tskpri, OZ_Pointer eip)
