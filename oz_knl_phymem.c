...

{
  ...
  /* It is OK for oz_hw_pool_init to decrement oz_s_phymem_totalpages if it wants to take the pages from the high end */
  ...
  /* On some systems (eg, Xen/486) oz_hw_pte_readany may crash on pages .lt. ffvirtpage       */
  /* Also, they may have all physical pages mapped, so don't scan below ffvirtpage            */

  for (i = ffvirtpage - OZ_HW_VADDRTOVPAGE (oz_s_sysmem_baseva); i < oz_s_sysmem_pagtblsz; i ++) {
