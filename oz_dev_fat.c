...
static char const *fat_get_volname (OZ_VDFS_Volume *volume);
...
static uLong fat_init_volume (OZ_VDFS_Devex *devex, OZ_VDFS_Volume *volume, int volnamelen, char const *volname, uLong clusterfactor, uLong secattrsize, const void *secattrbuff, uLong initflags, OZ_VDFS_Iopex *iopex);
...
static uLong fat_lookup_file (OZ_VDFS_File *dirfile, int namelen, char const *name, OZ_VDFS_Fileid *fileid_r, char *name_r, OZ_VDFS_Iopex *iopex);
static uLong fat_rename_file (OZ_VDFS_File *olddirfile, char const *oldname, OZ_VDFS_File *newdirfile, char const *newdirname, int newnamelen, char const *newname, int newversion, OZ_VDFS_File *file, const OZ_VDFS_Fileid *fileid, char *newname_r, OZ_VDFS_Iopex *iopex);
static uLong fat_enter_file (OZ_VDFS_File *dirfile, char const *dirname, int namelen, char const *name, int newversion, OZ_VDFS_File *file, const OZ_VDFS_Fileid *fileid, char *name_r, OZ_VDFS_Iopex *iopex);
static uLong fat_remove_file (OZ_VDFS_File *dirfile, char const *name, char *name_r, OZ_VDFS_Iopex *iopex);
static void fat_returnspec (char *spec, uLong size, char *buff, OZ_FS_Subs *subs);
static uLong fat_create_file (OZ_VDFS_Volume *volume, int namelen, char const *name, uLong filattrflags, OZ_VDFS_Fileid *dirid, OZ_VDFS_File *file, OZ_VDFS_Fileid **fileid_r, OZ_VDFS_Iopex *iopex);
...
static int makeshortname (int namelen, char const *name, uByte *shortname, uByte *dirattr_r);
static int makelongname (int namelen, char const *name, uByte *longnamebuf, uByte *shortname, uByte *dirattr_r);
...

{
  ...
  sts = fat_enter_file (newdirfile, newdirname, newnamelen, newname, newversion, file, fileid, newname_r, iopex);
  if (sts == OZ_SUCCESS) sts = fat_remove_file (olddirfile, oldname, NULL, iopex);
  return (sts);
}

/************************************************************************/
