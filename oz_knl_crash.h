...
typedef struct { char magic[8];			/* "oz_crash" */
                 ...
                 OZ_Mchargx **mchargx;		/* pointer to array of original kernel machine arg extension pointers */
                 ...
                 OZ_Mchargx mchargx_cpy;	/* copy of the kernel machine arg extensions */
               } OZ_Crash_block;

uLong oz_knl_crash_set (OZ_Iochan *iochan);
int oz_knl_crash_dump (Long cpuidx, OZ_Sigargs *sigargs, OZ_Mchargs **mchargs, OZ_Mchargx **mchargx);
