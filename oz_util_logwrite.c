...

{
  ...
  for (lastimage = NULL; (image = oz_knl_image_next (lastimage, 1, 1)) != NULL; lastimage = image) { // scan list of system images
    if (lastimage != NULL) oz_knl_image_increfc (lastimage, -1);
