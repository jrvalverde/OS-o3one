...
/*	          if OZ_SMPLOCK_NULL, implies enabling software 	*/
/*	                              interrupt delivery		*/
/*									*/
/*    Output:								*/
/*									*/
...
int oz_hw_atomic_setif_long (volatile Long *value, Long newval, Long oldval);
#endif

/* Same thing, but does it with pointers */

#ifndef oz_hw_atomic_setif_ptr
int oz_hw_atomic_setif_ptr (void *volatile *value, void *newval, void *oldval);
#endif

/************************************************************************/
/*									*/
...
/*	            (just save this value and return it via 		*/
/*	             oz_hw_pte_read)					*/
...
extern OZ_Debug_mchargsdes const oz_hw_mchargs_des[];	// standard machine arguments
extern OZ_Debug_mchargsdes const oz_hw_mchargx_des[];	// extended machine arguments
...
void oz_hw_mchargx_fetch (OZ_Mchargx *mchargx);				// transfer from cpu to mchargx struct
void oz_hw_mchargx_store (OZ_Mchargx *mchargx, OZ_Mchargx *mask);	// transfer from mchargx struct to cpu
