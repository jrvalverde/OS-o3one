...
#define OZ_HW_BASE_SYSC_VA (0)		/* system addresses go from 00000000 to 07FFFFFF (128M) */
#define OZ_HW_BASE_SYSC_VP (0)		/* system base page number */
#define OZ_HW_BASE_PROC_VA (0x08000000)	/* process addresses go from 08000000 to FFFFFFFF (4G-128M) */
#define OZ_HW_BASE_PROC_VP (0x08000)	/* process base page number */
...
typedef uLong OZ_Sigargs;
	...
	/* Must match MCH_... offsets in oz_params_486.s */
...
struct OZ_Mchargs { uLong ec2;				/* error code #2 */
	...
	/* Must match MCHX_... offsets in oz_params_486.s */
