...
handler_except_msg:
	.byte	13,10
	.ascii	"oz_hw486_idtinit: exception "
	.byte	-1
	.byte	0
...
handler_dumpmem_msg:
	...
	.align	4
	.globl	oz_hw486_idtinit
	.type	oz_hw486_idtinit,@function
oz_hw486_idtinit:
.if 000 ## BOCHS
	xorl	%eax,%eax
	movl	$256*4,%ecx
...
handler_PF:
	decb	lastflag			# hang if error printing error message
	js	hangforever
...
handler_stop:
	...
	IODELAY
	testb	%al,%al				# ignore key-ups
	js	handler_stop
	jmp	handler_dumpmem			# key down, dump another line
