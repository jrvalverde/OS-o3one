...
uLong oz_sys_password_getbyusername (char const *username, int nitems, OZ_Password_item *items, int *index_r, 
...
OZ_HW_SYSCALL_DCL_2 (password_change, char const *, oldpw, char const *, newpw)
