...
get_something_x:
  ...
  if (thread == NULL) {
    oz_hw_ldrwaitloop_body ();
    goto get_something_x;
  }
  oz_hw_ldrwaitloop_term ();

  /* Have a computable thread, lock thread list properly and test it out again */
