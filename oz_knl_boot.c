...

{
  ...
  if (oz_knl_process_getid (oz_s_systemproc) != OZ_KNL_BOOT_SYSPROCID) {
    oz_crash ("oz_knl_boot: systemproc id is %u, should be %u", oz_knl_process_getid (oz_s_systemproc), OZ_KNL_BOOT_SYSPROCID);
  }
