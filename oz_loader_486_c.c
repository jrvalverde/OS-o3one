...
{
  /* Just plunk it starting at OZ_LDR_KNLBASEVA */
...
/************************************************************************/
/*									*/
/*  Loader waitloop stuff goes through routines so the contents can be 	*/
/*  changed via linking.						*/
/*									*/
/************************************************************************/

void oz_hw_ldrwaitloop_init (void) { OZ_HW_WAITLOOP_INIT; }
void oz_hw_ldrwaitloop_body (void) { OZ_HW_WAITLOOP_BODY; }
void oz_hw_ldrwaitloop_term (void) { OZ_HW_WAITLOOP_TERM; }
