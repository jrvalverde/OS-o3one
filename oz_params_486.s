...
MAXSYSPAGES = 0x08000000/4096	# max possible total number of system pages 
				# ... it all ends before default link address 0x08048000
				# = 32K pages = 128Mbytes

				# MAXSYSPAGES used to be set as follows = (512*1024/4)
...
PROCBASVADDR = PROCBASVPAGE*4096				# corresponding virtual address (0x20000000)
	...
	INT_RDEBUG       = 0x51		# callable at any mode to read and write debug registers
	INT_WDEBUG       = 0x52
