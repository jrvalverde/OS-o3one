...
#define GETSIGNEDNUM \
	     if (p -> intsize == 1) signednum = va_arg (ap, Long);	\
	else if (p -> intsize == 2) signednum = va_arg (ap, Long);	\
...
#define GETUNSIGNEDNUM \
	     if (p -> intsize == 1) unsignednum = va_arg (ap, uLong);	\
	else if (p -> intsize == 2) unsignednum = va_arg (ap, uLong);	\
