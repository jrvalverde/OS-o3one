...

{
  ...
  /* Hopefully by now the IO adapter has taken all the L1 slots it wants from the end of the L1 page */
  /* So we plunk the kernel in the L1 slot just before all the IO pages                              */
