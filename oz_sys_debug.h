...
typedef struct {
	char const *name;	/* name of mchargs/mchargx register (excluding the %) */
...
typedef struct {
	...
	void (*abort) (void *cp, OZ_Sigargs *sigargs, OZ_Mchargs *mchargs, OZ_Mchargx *mchargx); /* internal error abort */
	...
	OZ_Debug_mchargsdes const *mchargsdes;							/* standard machine arguments descriptor table */
	OZ_Debug_mchargsdes const *mchargxdes;							/* extended machine arguments descriptor table */
} OZ_Debug_callback;
