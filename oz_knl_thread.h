...
/* Thread resume (from debugging) codes (bitmask) - returned by oz_knl_thread_attach's entry routine */

#define OZ_THREAD_HALT_RESUME 1			/* resume (ie, retry) instruction that trapped */
#define OZ_THREAD_HALT_ATTACH 2			/* remain attached */
#define OZ_THREAD_HALT_LOOPBK 4			/* loopback after possibly dequeing ast */
