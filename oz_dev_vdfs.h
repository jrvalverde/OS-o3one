...
#if OZ_VDFS_VERSION != 5
  error : caller is version OZ_VDFS_VERSION but I am version 5
#endif
...
struct OZ_VDFS_Vector {
	...
	uLong (*rename_file) (OZ_VDFS_File *olddirfile, const char *oldname, OZ_VDFS_File *newdirfile, const char *newdirname, int newnamelen, const char *newname, int newversion, OZ_VDFS_File *file, const OZ_VDFS_Fileid *fileid, char *name_r, OZ_VDFS_Iopex *iopex);
