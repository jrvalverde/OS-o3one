...
OZ_HW_SYSCALL_DCL_4 (thread_exiteh, uLong, status, OZ_Exhand_entry *, exhentry_r, void **, exhparam_r, uLong *, status_p)
...
OZ_HW_SYSCALL_DCL_2 (thread_getid, OZ_Handle, h_thread, OZ_Threadid *, threadid_r)
...
OZ_HW_SYSCALL_DCL_8 (thread_attach, OZ_Handle, h_thread, 
...
OZ_HW_SYSCALL_DCL_2 (thread_halt, OZ_Handle, h_thread, OZ_Procmode, procmode)
uLong oz_sys_thread_halted (OZ_Sigargs const *sigargs, OZ_Mchargs *mchargs);
OZ_HW_SYSCALL_DCL_3 (thread_haltcheck, OZ_Sigargs const *, sigargs, OZ_Mchargs *, mchargs, OZ_Mchargx *, mchargx)
