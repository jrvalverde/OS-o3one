...

{
  ...
  oz_sys_io_fs_printerror ("oz_sys_condhand_default: unhandled condition\n");
  oz_sys_io_fs_printerror ("     thread: %u %s\n", threadid, threadname);
  oz_sys_io_fs_printerror ("    process: %u %s\n", processid, processname);
  oz_sys_io_fs_printerror ("        job: %s\n", jobname);
  oz_sys_io_fs_printerror ("       user: %s\n", username);
  oz_sys_io_fs_printerror ("    sigargs:");
  for (i = 0; i <= sigargs[0]; i ++) oz_sys_io_fs_printerror (" %u (0x%X)", sigargs[i], sigargs[i]);
