...

{
  ...
  oz_s_syscalltbl[OZ_SYSCALL_spawn2]                  = oz_syscall_spawn2;
  ...
  oz_s_syscalltbl[OZ_SYSCALL_thread_haltcheck]        = oz_syscall_thread_haltcheck;
  oz_s_syscalltbl[OZ_SYSCALL_section_setpageprot]     = oz_syscall_section_setpageprot;
  oz_s_syscalltbl[OZ_SYSCALL_thread_halt]             = oz_syscall_thread_halt;
  ...
  oz_s_syscalltbl[OZ_SYSCALL_process_peek]            = oz_syscall_process_peek;
  oz_s_syscalltbl[OZ_SYSCALL_process_poke]            = oz_syscall_process_poke;
  oz_s_syscalltbl[OZ_SYSCALL_thread_attach]           = oz_syscall_thread_attach;
  oz_s_syscalltbl[OZ_SYSCALL_thread_getid]            = oz_syscall_thread_getid;
  oz_s_syscalltbl[OZ_SYSCALL_process_getthreadqseq]   = oz_syscall_process_getthreadqseq;
  oz_s_syscalltbl[OZ_SYSCALL_process_imagelist]       = oz_syscall_process_imagelist;
  oz_s_syscalltbl[OZ_SYSCALL_process_setbreaks]       = oz_syscall_process_setbreaks;
  oz_s_syscalltbl[OZ_SYSCALL_exhand_delete]           = oz_syscall_exhand_delete;
  oz_s_syscalltbl[OZ_SYSCALL_random_fill]             = oz_syscall_random_fill;
